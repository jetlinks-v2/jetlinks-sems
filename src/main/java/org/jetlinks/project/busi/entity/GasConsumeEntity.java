...
import org.jetlinks.project.busi.enums.PeriodsEnum;

import javax.persistence.Column;
import javax.persistence.Table;
import java.math.BigDecimal;

@Table(name = "sems_gas_consume")
@Getter
@Setter
@Schema(description = "用气信息表")
@EnableEntityEvent //开启实体类crud事件
public class GasConsumeEntity extends GenericEntity<String> implements RecordCreationEntity, RecordModifierEntity {
