...
import org.jetlinks.project.busi.enums.ChangeTypeEnum;
...
@Table(name = "sems_change_record")
@Getter
@Setter
@Schema(description = "登记变更记录表")
@EnableEntityEvent //开启实体类crud事件
public class ChangeRecordEntity extends GenericEntity<String> implements RecordCreationEntity, RecordModifierEntity {
    ...
    @DefaultValue("0")
    @Schema(description = "标志，0：设备，1：区域")
    private String flag;
